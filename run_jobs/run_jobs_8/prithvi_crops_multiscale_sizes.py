"""Submit jobs for Prithvi Multi-Scale Conv3d at multiple crop sizes with 8 months.

Best 4-month params per crop size (from best_params.csv):
  crop32:  lr=0.001, batch=72,  epoch_len=11250, epochs=150
  crop48:  lr=0.001, batch=16,  epoch_len=5000,  epochs=150
...
8-month adjustment (T: 4->8, ~2x memory):
  crop32:  batch 72->36, sweep [36, 72]
  crop48:  batch 16->8,  sweep [8, 16]
  crop96:  batch 4->2,   sweep [2, 4]
  crop144: batch 4->2,   sweep [2, 4]
  crop224: batch 1->1,   sweep [1, 2] (already at minimum)
"""
import os
import sys
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))
from run_jobs_8.common import is_done, setup_records_dir
...
# ===== Crop size configs (best 4-month params, batch adjusted for 2x memory) =====
crop_configs = {
    ...
    96:  {"learning_rate": 0.001,  "batch_sizes": [2, 4],   "grad_accum_steps": 1, "epoch_length": 1250,  "epochs": 150},
