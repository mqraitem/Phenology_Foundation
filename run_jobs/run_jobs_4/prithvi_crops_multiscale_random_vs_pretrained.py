"""Submit jobs for Prithvi Multi-Scale Conv3d: random init vs pretrained (crop=48)."""
import os
import sys
...
init_configs = {
    # "pretrained": {"load_checkpoint": True,  "group": "prithvi_pretrained_multiscale_crops_conv3d"},
    "random":     {"load_checkpoint": False, "group": "prithvi_random_multiscale_crops_conv3d"},
}

for init_name, init_cfg in init_configs.items():
    load_checkpoint = init_cfg["load_checkpoint"]
    group_name = init_cfg["group"]
