"""Submit jobs for Prithvi Pretrained Conv3d CatHLS Random Crops."""
import os
import sys
...
# ===== Sweep grid (matches existing checkpoints) =====
learning_rates = [0.0005, 0.001]
backbone_lr_scales = [0.1, 0.5, 1.0]
batch_sizes = [16, 32]
progressive_fusions = [False, True]

group_name = "prithvi_pretrained_crops_cathls_conv3d"
for progressive_fusion in progressive_fusions:
